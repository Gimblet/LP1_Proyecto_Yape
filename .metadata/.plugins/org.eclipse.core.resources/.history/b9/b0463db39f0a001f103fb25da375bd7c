				...
				<table class="table table-hover table-striped border rounded">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<!-- SVG = Referencia Iconos de boostrap  -->
								...
								<a title="Editar" href="Servlet?type=Buscar Yape a Editar&id=<%=item.getIdYape()%>">
								...
								<a title="Eliminar" href="Servlet?type=Eliminar Yape&id=<%=item.getIdYape()%>&numeroRec=<%=item.getNumeroRecibiente()%>&numeroRem=<%=item.getNumeroRealizante()%>&monto=<%=item.getMonto()%>">
