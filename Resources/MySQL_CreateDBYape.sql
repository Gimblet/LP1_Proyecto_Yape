...
(
	COD_CLI			INT				NOT NULL AUTO_INCREMENT,     	-- CODIGO
...
(
	COD_ADM			INT			 	NOT NULL AUTO_INCREMENT, 		-- CODIGO
    COM_ADM			DOUBLE   	 	NOT NULL,						-- COMISION DEL MES
...
(
	COD_HEA			INT			 NOT NULL AUTO_INCREMENT,			-- CODIGO
    SUE_HEA			DOUBLE		 NOT NULL CHECK(SUE_HEA > 0),		-- SUELDO
    PRIMARY KEY(COD_HEA),
